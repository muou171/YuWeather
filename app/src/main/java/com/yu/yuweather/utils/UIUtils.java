...
public class UIUtils {
    ...
    public static void showDailyForecastDetailDialog(Activity activity, DailyForecast.DailyBean.DataBean dataBean) {
        ...
        if (icon.equals("snow")) {
            ...
            tvDailyDataSunriseTime.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            ivDailyDataSunsetIcon.setImageResource(R.drawable.ic_sunset_gray);
            tvDailyDataSunsetTime.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMinPrompt.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMin.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMinUnit.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMinTimePrompt.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMinTime.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMaxPrompt.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMax.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMaxUnit.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMaxTimePrompt.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            tvDailyDataTemperatureMaxTime.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayDark));
            ivUmbrella.setImageResource(R.drawable.ic_umbrella_gray);
            tvDailyDataPreProbability.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
            tvDailyDataPreProbabilityUnit.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
            ivHumidity.setImageResource(R.drawable.ic_humidity_gray);
            tvDailyDataHumidity.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
            tvDailyDataHumidityUnit.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
            ivPressure.setImageResource(R.drawable.ic_pressure_gray);
            tvDailyDataPressure.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
            tvDailyDataPressureUnit.setTextColor(ColorUtils.GetResourceColor(activity, R.color.colorGrayLight));
        }
